...
namespace com.shepherdchurch.Misc.DataFilter
{
    /// <summary>
    /// 
    /// </summary>
    [Description( "Filter groups on whether any locations are within the geofenced boundary of the specified location" )]
    [Export( typeof( DataFilterComponent ) )]
    [ExportMetadata( "ComponentName", "Group In Location Geofence Filter" )]
    public class GroupInLocationGeofenceFilter : DataFilterComponent
    {
        #region Properties
...
";
        ...
        public override Control[] CreateChildControls( Type entityType, FilterField filterControl )
        {
            ...
            DefinedTypeCache locationDefinedType = DefinedTypeCache.Get( Rock.SystemGuid.DefinedType.GROUP_LOCATION_TYPE.AsGuid() );
        ...
        public override Expression GetExpression( Type entityType, IService serviceInstance, ParameterExpression parameterExpression, string selection )
        {
            ...
            var groupLocationQry = new GroupLocationService( rockContext )
                .Queryable()
                .Where( gl => gl.Location != null && gl.Location.GeoPoint != null && gl.Location.GeoPoint.Intersects( geoFence ) );
            ...
            var qry = new GroupService( rockContext ).Queryable()
                .Where( g => groupLocationQry.Any( xx => xx.GroupId == g.Id ) );

            Expression extractedFilterExpression = FilterExpressionExtractor.Extract<Rock.Model.Group>( qry, parameterExpression, "g" );
